...
- `08dae9b feat(voice): expand abbreviations before TTS (mph -> miles per hour) (4 hours ago)`
- `ee1f19b fix(startup): stop the duplicate R.A.M.B.O tab on boot (4 hours ago)`
- `18de5e9 feat(cmc): render daily Word doc as tables with section headers (6 hours ago)`
- `5de319a Fix k_projection correctness, BF rendering, and test date hygiene (7 hours ago)`
- `42fceec chore(betting): record alt-K calibration backtest result (7 hours ago)`
- `a0586c2 fix(betting): omit misleading roi/avg_clv from k_backtest pure calibration (7 hours ago)`
- `d8d1a6f feat(betting): leak-free strikeout calibration backtest (7 hours ago)`
- `cf04f2d feat(betting): alt-K board shows full P(1+..10+) ladder (7 hours ago)`
...
- `89d6a53 docs(betting): implementation plan for alt-K board phase 1 (8 hours ago)`
- `d2c4b5f docs(betting): spec alt-K board phase 1 (model + calibration) (8 hours ago)`
- `4782c70 Apply 6 minor code review fixes: explicit None checks for ERA (0.00 ERA), defensive empty-X guard in logreg.fit, docstring for coefficients standardization note, backtest verdict dict safety, remove redundant TestClient import, and last_fit_date assertion. (8 hours ago)`
- `070e6e2 chore(betting): record learned-model May backtest vs baseline (11 hours ago)`
- `a1e5993 feat(betting): model param on /backtest + side-by-side compare CLI (11 hours ago)`
- `baba5b1 refactor(betting): walkforward.run takes a pluggable predictor (11 hours ago)`
- `99e03ee feat(betting): Anchored + LogReg predictors (11 hours ago)`
- … and 228 more
