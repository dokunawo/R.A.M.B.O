...
Last 14 days — 81 commits:

- `3c93d04 feat: initialize DispatchRepo on startup and attach to orchestrator (2 minutes ago)`
- `7b53f24 feat: inject dispatch context into router and voice (5 minutes ago)`
- `2c17365 feat: log dispatches to DispatchRepo from orchestrator (best-effort) (8 minutes ago)`
- `5814b92 feat: add DispatchRepo.format_for_prompt context block (11 minutes ago)`
- `fca76fa feat: add DispatchRepo persistence (schema, register, update, queries) (14 minutes ago)`
- `1976e26 feat: route on the fast model tier (16 minutes ago)`
- `8832f42 feat: add fast_model tier to model_config (20 minutes ago)`
- `a0716de docs: implementation plan for dispatch memory + model split (23 minutes ago)`
- `da27915 docs: design for persistent dispatch memory + fast/deep model split (29 minutes ago)`
