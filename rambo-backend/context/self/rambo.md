...
Last 14 days — 281 commits:

- `0d83704 docs(betting): PrizePicks demon/goblin tier board implementation plan (4 minutes ago)`
- `23f3d1a docs(betting): PrizePicks demon/goblin tier board design spec (7 minutes ago)`
- `6f6e97c feat(betting): auto-fallback to paid PrizePicks actor when free pull empty (26 minutes ago)`
- `59cc3f2 feat(betting): wire prizepicks_paid source; verify normalizer flow-through (31 minutes ago)`
- `2afa030 feat(betting): fetch_mlb_props_paid — spend-guarded run + never-raise (35 minutes ago)`
- `ecfc127 feat(betting): defensive adapter for paid PrizePicks actor items (38 minutes ago)`
- `e96985b feat(betting): env-driven paid PrizePicks Apify actor config (42 minutes ago)`
- `2284651 docs(betting): PrizePicks paid Apify fallback implementation plan (44 minutes ago)`
- `0ca00f5 docs(betting): PrizePicks paid Apify fallback design spec (47 minutes ago)`
- `ad0a464 fix(betting): default best-leg book to "" not "FanDuel" to avoid mislabel (71 minutes ago)`
- `b27056c test(phase3): force web-search fallback in news/finance skill tests (74 minutes ago)`
- `06b91fd fix(betting): guard post_alt_k_parlay against board failures and empty sizes (81 minutes ago)`
- `06d27a5 feat(betting): /alt-k-board + /alt-k/parlay endpoints (85 minutes ago)`
