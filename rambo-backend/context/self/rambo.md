...
- `0be0b91 feat(hud): push-approval feedback — 'Staged' → 'Pushed ✓' then auto-clears (64 minutes ago)`
- `c1ad60d feat(betting): prop→game linking + team confirmation; harden Pick6 MLB filter (82 minutes ago)`
...
- `b44e708 feat(ev): Player Watch is slate-wide with our leans pinned at top (21 hours ago)`
- … and 184 more
