...
- `0be0b91 feat(hud): push-approval feedback — 'Staged' → 'Pushed ✓' then auto-clears (17 minutes ago)`
- `c1ad60d feat(betting): prop→game linking + team confirmation; harden Pick6 MLB filter (35 minutes ago)`
- `baf4ac6 feat(ui): cinematic shutdown/standby sequence + tabbed task-history panel (48 minutes ago)`
