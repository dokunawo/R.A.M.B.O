...
Last 14 days — 43 commits:

- `dd3e1b7 Cost dashboard: live LLM token usage and cost tracking (41 minutes ago)`
- `d0f7518 Voice streaming, self-knowledge system, roadmap and README updates (79 minutes ago)`
- `cf495c9 Shared HUD on all pages, Learning Log redesign, remove ChromaticAberration (3 hours ago)`
- `1ba1078 Fix mic button overlap, neon glass response popups (3 hours ago)`
- `fa0a3f5 Add percentage-based volume control with voice commands (4 hours ago)`
- `45c08fb Replace SplashScreen custom mic/sound buttons with VoiceControls component (4 hours ago)`
- `e105a20 Bottom-center mic button, response card polish, glass on splash controls (4 hours ago)`
- `521d5cf Apply glass-morphism across all UI panels (4 hours ago)`
...
- `f72fd1f Response branches: tree structure from orb center on agent pages (15 hours ago)`
- `b81ef90 Add quick-switch agent bar to bottom of agent pages (15 hours ago)`
- `d9dd0e8 Restore agent page info as Phase 2-style side panels (15 hours ago)`
- `4930cd8 Add Chief of Staff skill to R.A.M.B.O backend (15 hours ago)`
- `07e5dd5 Add Google Drive integration (16 hours ago)`
- `38b58f7 Add Google Calendar integration (16 hours ago)`
