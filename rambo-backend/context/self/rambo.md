...
Last 14 days — 162 commits:

- `2bec4a8 fix(ev): strikeouts market is DK 'SO' not 'K'; dedupe slip to one play per player (20 minutes ago)`
- `cb6e0e7 feat(ev): per-market slip export (GET /betting/slip) for ChatGPT-image flow (33 minutes ago)`
- `307e3c1 docs: consolidate all roadmaps into one ROADMAP.md; refresh README (7 hours ago)`
- `a12a63f feat(cmc): poster texture system + branded-plate slot (14 hours ago)`
...
- `5b6b44c feat(cmc): downloadable Daily Edge poster (/card/:market) via html-to-image (15 hours ago)`
- `7d728c3 feat(cmc): Daily Edge card — moneyline leans lead, props as honest -EV skips (15 hours ago)`
- `fba6e87 feat(ev): market-anchor moneyline to de-vigged book (honest bounded leans) (15 hours ago)`
...
- `0f506ec fix(ev): skip null-multiplier props; lock split keys; deterministic DH; cleanup (16 hours ago)`
- `ffd106a feat(ev): /betting/daily-edge endpoint + mount (16 hours ago)`
- `2f4eff7 feat(ev): daily_edge orchestrator (rank + explain) (16 hours ago)`
- `5252270 feat(ev): per-slate LLM explainer with templated fallback (16 hours ago)`
- `6421de7 feat(ev): HR market builds ranked Pick candidates (16 hours ago)`
- `22cd9d8 feat(ev): HR feature assembly from MlbRepo (16 hours ago)`
- … and 142 more
