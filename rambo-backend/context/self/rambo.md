...
Last 14 days — 54 commits:

- `db6070c Frontend docks for confirmation gate (Tier 4) and handoffs (Tier 5) (31 minutes ago)`
- `6179eed Auto-load rambo-backend/.env on startup (37 minutes ago)`
- `4bdd746 Tier 5 — handoff system (propose, don't chain) (48 minutes ago)`
- `6fe3149 Tier 4 — tool-level human-in-the-loop confirmation gates (51 minutes ago)`
...
- `ea349c4 Add glass-morphism and teal CSS variables to :root (11 hours ago)`
- … and 34 more
