...
Last 14 days — 131 commits:

- `9dc8e98 Persistent Q&A history: transcript store + History page, dock, and copy buttons (4 minutes ago)`
...
- `752260e UI: stack left docks in a rail (no overlap) + split volume controls (13 hours ago)`
...
- `ee769d3 Voice always-on, reliable screen-share auto-start, intro sound fix (22 hours ago)`
...
- `f6da9f6 docs: reflect consolidated agent roster in README (32 hours ago)`
