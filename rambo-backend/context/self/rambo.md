...
Last 14 days — 148 commits:

- `0f506ec fix(ev): skip null-multiplier props; lock split keys; deterministic DH; cleanup (18 minutes ago)`
- `ffd106a feat(ev): /betting/daily-edge endpoint + mount (25 minutes ago)`
- `2f4eff7 feat(ev): daily_edge orchestrator (rank + explain) (28 minutes ago)`
- `5252270 feat(ev): per-slate LLM explainer with templated fallback (30 minutes ago)`
- `6421de7 feat(ev): HR market builds ranked Pick candidates (32 minutes ago)`
- `22cd9d8 feat(ev): HR feature assembly from MlbRepo (35 minutes ago)`
- `588171f feat(ev): repo lookups for game context + pitcher hand (38 minutes ago)`
- `6900a65 feat(ev): migration 003 — probable pitchers + team abbrs on games (41 minutes ago)`
- `487e92c feat(ev): Pick + HRFeatures types (card contract) (45 minutes ago)`
- `be6fcce feat(ev): HR probability + Pick6 edge math (47 minutes ago)`
- `433bdbb feat(ev): HR park-factor table (49 minutes ago)`
- `b6ba289 docs: EV Brain (home runs) implementation plan (60 minutes ago)`
- `917c2fc docs: lock Pick output shape + card styling to the CMC card (68 minutes ago)`
- `d1555ca docs: add Strikeouts (pitcher prop) to EV Brain market list (72 minutes ago)`
- `e02da85 docs: EV Brain (home runs) design spec (77 minutes ago)`
