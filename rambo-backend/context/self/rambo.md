...
Last 14 days — 86 commits:

- `5097876 feat: add ElevenLabsTTS best-effort client (6 minutes ago)`
- `2afd7e6 docs: implementation plan for ElevenLabs neural voice (16 minutes ago)`
- `e0a94ac docs: design for ElevenLabs neural voice (37 minutes ago)`
- `ef630e5 fix: dedicated completed-rows query + elapsed annotation in dispatch context (55 minutes ago)`
- `feb1e11 fix: make dispatch-repo helpers resilient to missing attribute (streaming regression) (61 minutes ago)`
- `3c93d04 feat: initialize DispatchRepo on startup and attach to orchestrator (64 minutes ago)`
- `7b53f24 feat: inject dispatch context into router and voice (67 minutes ago)`
- `2c17365 feat: log dispatches to DispatchRepo from orchestrator (best-effort) (70 minutes ago)`
- `5814b92 feat: add DispatchRepo.format_for_prompt context block (72 minutes ago)`
- `fca76fa feat: add DispatchRepo persistence (schema, register, update, queries) (75 minutes ago)`
- `1976e26 feat: route on the fast model tier (78 minutes ago)`
- `8832f42 feat: add fast_model tier to model_config (81 minutes ago)`
- `a0716de docs: implementation plan for dispatch memory + model split (85 minutes ago)`
...
- `9f2e0a9 Startup: launch Chrome in a dedicated new window, fullscreen (F11-style) (15 hours ago)`
- … and 66 more
