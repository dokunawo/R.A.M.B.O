...
Last 14 days — 59 commits:

- `2816c24 Update roadmap and README: orchestration tiers 4-5, caching, go-live fixes, startup, mic redesign (4 minutes ago)`
- `90e223e Add nginx SPA fallback (fix deep-link/refresh 404s) + red blocked-mic ring (14 minutes ago)`
- `845155b Redesign mic button (glass + gold glow) and surface a visible mic-blocked state (20 minutes ago)`
- `934c999 Add rambo-startup.ps1: seamless boot (wait for Docker, compose up, wait for frontend, open browser) (33 minutes ago)`
- `0da4e4b Fix two bugs blocking live model calls; centralize model id (39 minutes ago)`
- `db6070c Frontend docks for confirmation gate (Tier 4) and handoffs (Tier 5) (70 minutes ago)`
- `6179eed Auto-load rambo-backend/.env on startup (76 minutes ago)`
- `4bdd746 Tier 5 — handoff system (propose, don't chain) (87 minutes ago)`
