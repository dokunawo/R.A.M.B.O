...
Last 14 days — 249 commits:

- `cc6b107 fix(briefing): de-dupe greeting, speak north star + system, inject north star into reasoning (43 minutes ago)`
- `4997450 feat(ui): move power button below "TAP OR SAY 'OPERATOR'" (4 hours ago)`
- `da8b4a2 fix(dev-lane): self-heal stuck drafting changes (4 hours ago)`
...
- `219933e feat(betting): k_projection — opponent-adjusted rate x batters-faced (8 hours ago)`
- `9d8f998 feat(betting): point-in-time opponent K% + pitcher K/BF reads (8 hours ago)`
- `a330c2a feat(betting): binomial K-distribution model + opponent modifier (8 hours ago)`
...
- `070e6e2 chore(betting): record learned-model May backtest vs baseline (11 hours ago)`
- `a1e5993 feat(betting): model param on /backtest + side-by-side compare CLI (12 hours ago)`
- `baba5b1 refactor(betting): walkforward.run takes a pluggable predictor (12 hours ago)`
- … and 229 more
