...
- `69fed12 feat(ui): boot briefing fires after Phase 2 cascade, as one spoken sequence (2 hours ago)`
- `c59b003 feat(ui): /boards page — all four parlay boards on one screen (5 hours ago)`
- `759d304 feat(ev): Hits & Total Bases Watch — P(1+ hit)/P(2+ TB) board for hits parlays (6 hours ago)`
- `5dadebe feat(ev): Strikeout Watch — top-11 starters by P(8+/9+/10+ K) for alt-K parlays (6 hours ago)`
...
- `824b59b feat(git): operator-approved GitHub push (commit + push behind a confirm gate) (17 hours ago)`
- `fc90ed9 feat(builds): auto-generate run.bat/run.sh launchers so builds run without IDLE (17 hours ago)`
- `e1f3a1a docs: build naming, build deletion, quieter hand-offs (guide/README/roadmap) (17 hours ago)`
- `66a571d feat(builds): short build names, delete capability, Engineer-only handoff mentions (17 hours ago)`
...
- `b44e708 feat(ev): Player Watch is slate-wide with our leans pinned at top (19 hours ago)`
- `1d67c70 fix(startup): single-instance lock so RAMBO never opens two Chrome windows (19 hours ago)`
...
- `ea16e0b feat(ev): moneyline_board (full slate) builder + prompt (20 hours ago)`
- … and 178 more
