...
- `0be0b91 feat(hud): push-approval feedback — 'Staged' → 'Pushed ✓' then auto-clears (44 minutes ago)`
- `c1ad60d feat(betting): prop→game linking + team confirmation; harden Pick6 MLB filter (62 minutes ago)`
- `baf4ac6 feat(ui): cinematic shutdown/standby sequence + tabbed task-history panel (75 minutes ago)`
