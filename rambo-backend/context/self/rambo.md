...
Last 14 days — 163 commits:

- `a5719a4 fix(ev): moneyline used in-game 'Live Odds' (+440) instead of pregame line (54 minutes ago)`
- `2bec4a8 fix(ev): strikeouts market is DK 'SO' not 'K'; dedupe slip to one play per player (75 minutes ago)`
- `cb6e0e7 feat(ev): per-market slip export (GET /betting/slip) for ChatGPT-image flow (87 minutes ago)`
...
- `f70b4c1 feat(cmc): cinematic poster redesign — brush fonts, black/gold, tall cards (15 hours ago)`
- `c1310b3 feat(cmc): metallic gold-foil text, SVG smoke/gold texture, stronger neon glow (15 hours ago)`
- `2a87814 feat(cmc): landscape poster with real headshots, CMC logo header + banner (15 hours ago)`
...
- `27bedcd feat(ev): H+R+RBI and Stolen Bases markets (Poisson count model) (16 hours ago)`
...
- `6421de7 feat(ev): HR market builds ranked Pick candidates (17 hours ago)`
- … and 143 more
