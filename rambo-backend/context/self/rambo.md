...
Last 14 days — 110 commits:

- `55a3a2f Add codebase skill: R.A.M.B.O can read its own repo (57 minutes ago)`
- `ef7df1b Consolidate remaining UI surfaces to 3-mode lineup (73 minutes ago)`
- `34a640e Consolidate agent fleet into 3 routable modes + services (86 minutes ago)`
...
- `99a5b7b feat: recurring morning brief (on-screen card + email) (11 hours ago)`
- `e6206ec fix: route email/notify intents to Echo (notify skill), not converse (11 hours ago)`
...
- `e5a6e71 feat: hands-free 'command center' voice command opens the Command Center (12 hours ago)`
- `b3194fd feat: sound on by default + Settings panel with Sound toggle (12 hours ago)`
...
- `4edbecb docs: design for ElevenLabs voice-credit tracker (16 hours ago)`
...
- `825e783 feat: add converse target + prefer action over clarifying (17 hours ago)`
- … and 90 more
