...
Last 14 days — 266 commits:

- `07d4729 feat(betting): join k_model ladder to alt-K odds (FanDuel + best book) (6 minutes ago)`
- `3d2c307 feat(betting): alt-K per-leg + parlay EV math (9 minutes ago)`
- `28d027b test(betting): verify alt-K event lands per-line SO_ALT prop rows (13 minutes ago)`
- `cf22a90 feat(betting): pull pitcher_strikeouts_alternate as SO_ALT market (17 minutes ago)`
- `830a898 docs(betting): alt-strikeout parlay builder implementation plan (20 minutes ago)`
- `5cb1669 docs(betting): alt-strikeout parlay builder design spec (24 minutes ago)`
- `243b4a3 feat(betting): prep pulls PrizePicks + resolves prop game_pk; retire dead Pick6 (39 minutes ago)`
- `335f0de feat(betting): /betting/prizepicks board + parlay endpoints (45 minutes ago)`
- `c1accd9 feat(betting): PrizePicks model-confidence boards (6 markets) (51 minutes ago)`
- `e97104f feat(betting): Power/Flex parlay EV (Poisson-binomial) (56 minutes ago)`
- `6c36e4b feat(betting): PrizePicks source route + normalizer (standard tier, 6 markets) (61 minutes ago)`
- `f0374fe feat(betting): direct PrizePicks API client (JSON:API join, free) (67 minutes ago)`
- `20e5b50 feat(betting): PrizePicks config — market map + Power/Flex tables (71 minutes ago)`
- `f9e0e17 docs(betting): implementation plan for PrizePicks boards + parlay EV (80 minutes ago)`
- `71b1b9d docs(betting): spec PrizePicks boards + Power/Flex parlay EV (85 minutes ago)`
